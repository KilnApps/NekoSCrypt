...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 NEKO with
        the avoid_reuse flag set to false. This means the 10 NEKO send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 NEKO to A.
        [1] spends 5 NEKO from A. (leaving roughly 5 NEKO useable)
        [0] sends 10 NEKO to A again.
        [1] tries to spend 10 NEKO (fails; dirty).
        [1] tries to spend 4 NEKO (succeeds; change address sufficient)
        '''
