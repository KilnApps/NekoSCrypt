...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NekoSCrypt address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nekoscrypt: URIs)"));
    ...
    historyAction->setStatusTip(tr("Get a list of transactions"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NekoSCrypt addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NekoSCrypt addresses"));
    ...
    openAction->setStatusTip(tr("Open a nekoscrypt: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible NekoSCrypt command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to NekoSCrypt network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
