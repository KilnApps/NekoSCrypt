...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nekoscrypt-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nekoscrypt-tx [options] <hex-tx> [commands]  Update hex-encoded nekoscrypt transaction\n" +
            "or:     nekoscrypt-tx [options] -create [commands]   Create hex-encoded nekoscrypt transaction\n" +
            "\n";
